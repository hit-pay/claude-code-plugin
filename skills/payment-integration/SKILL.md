...
description: Integrate HitPay payment gateway for online payments in Next.js and JS/TS applications. Use when user says "Add HitPay", "HitPay checkout", "HitPay payments", "PayNow integration", "HitPay integration", "payment gateway", or "accept payments".
license: MIT
metadata:
  author: hitpay
  version: "1.0.0"
...
> **Need the Drop-In UI?** For HitPay.js embedded checkout modal, see the **drop-in-ui** skill.
> **Operating payments via MCP tools?** For provider-currency mapping and QR operations, use the **payment-methods** skill.
